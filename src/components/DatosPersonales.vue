...
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/leandro-cattai-b14056216/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/leanncattai/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/leancattai' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 9 2604-849175';
</script>
