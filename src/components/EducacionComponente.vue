...
const educacion = ref([
  ...
  {fecha: '2024', title: 'Data Base Analyst', descripcion: 'Se inicio capacitaciòn en Global Solutions, donde me encargaba del analysis y planificacion de las bases de datos, con Python (pandas), excel, Workbench SQL y PowerBI', enlace:'https://gsolutions.ar/'},
  {fecha: '2022', title: 'Internship en NearTech', descripcion: 'Realice pasantias en NearTech una empresa contable que ofrece servicios de Tango Gestion, donde desarrolle mas que nada conocimientos y proyectos en WORDPRESS.', enlace:'https://neartech.com.ar/'},
  {fecha: '2020', title: 'Curso de Introducción a la Programación', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí lenguajes como Python y Java.', enlace:'https://ies9012.edu.ar/sigeaweb/'}
]);
</script>
